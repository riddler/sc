defmodule SC.Parser.SCXML.StateStackCoverageTest do
  ...
  describe "StateStack edge cases for coverage" do
    ...
    test "handle_state_end with final parent nesting" do
      ...
      final_parent = %SC.State{
        id: "final_parent",
        type: :final,
        states: []
      }

      nested_state = %SC.State{
        id: "nested_in_final",
        type: :atomic,
        states: [],
        transitions: []
    ...
    test "update_state_type for final state" do
      ...
      final_state = %SC.State{
        id: "test_final",
        type: :final,
        states: [%SC.State{id: "child", type: :atomic, states: [], transitions: []}]
      }

      nested_child = %SC.State{
        id: "new_child",
        type: :atomic,
        states: [],
        transitions: []
