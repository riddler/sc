defmodule SCIONTest.Error.ErrorTest do
  use SC.Case
  @tag :scion
  @tag required_features: [:basic_states, :conditional_transitions, :event_transitions, :final_states, :log_elements, :onentry_actions, :script_elements, :targetless_transitions]
  @tag spec: "error"
  test "error" do
    xml = """
    ...
    test_scxml(xml, "", ["s1"], [{%{"name" => "e1"}, ["pass"]}])
  end
end
