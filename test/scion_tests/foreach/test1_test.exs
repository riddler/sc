defmodule SCIONTest.Foreach.Test1Test do
  use SC.Case
  @tag :scion
  @tag required_features: [:assign_elements, :basic_states, :conditional_transitions, :data_elements, :datamodel, :event_transitions, :log_elements, :onentry_actions]
  @tag spec: "foreach"
  test "test1" do
    xml = """
