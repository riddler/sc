defmodule SCXMLTest.SelectingTransitions.Test405 do
  use SC.Case
  @tag :scxml_w3
  @tag required_features: [:basic_states, :compound_states, :event_transitions, :final_states, :log_elements, :onentry_actions, :onexit_actions, :parallel_states, :raise_elements, :send_elements]
